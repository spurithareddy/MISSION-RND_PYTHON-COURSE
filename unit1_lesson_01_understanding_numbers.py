...
def test_numbers_types():
    ...
    assert isinstance(7, int)  # checks if the object (first argument) is an instance or subclass of classinfo class (second argument).
    assert isinstance(7.5, float)
    assert type(7) is int
    assert type(7.5) is float
...
- isinstance() function 
- conversion into different number systems
- math.isclose()method 
"""