...
def test_equality():
    ...
    assert True == (0 == False)  # what happened here?  # 0 and 1 are treated as equivalent to False and True respectively, 1 or any integer except 0 is equivalent to True
    assert True == (1 == True)
    assert False == ("a" == True)
...
- empty objects boolean value is false by default
- None is considered as false
- object comparison with boolean values return false if they are not equal by value
"""
