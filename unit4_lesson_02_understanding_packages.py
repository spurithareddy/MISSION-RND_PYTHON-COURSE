...
def test_package_sub_packages():
    ...
    print(subpackage.m1.__doc__) # BECAUSE WE explicitly IMPORTED Package1.subpackage.m1. in init of subpackage

    assert True == ("package1.subpackage.m1" in sys.modules)

three_things_i_learnt = """
- NAMESPACE PACKAGES,regular packages,explicitly importing modules to init
- about sys.modules,sys.path
-
"""
