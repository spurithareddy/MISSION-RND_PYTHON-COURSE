...
- python stores a array of [-5 - 256] so all the numbers with in the range has same referrence 
- identity is about address of the object(same object)
- equality is about equality of values present in  objects
"""
